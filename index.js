...
say(`Created By Johnleo\nYOUTUBE : HacktivistHive\nCountry: Nigeria 🇳🇬\nWhatsapp : +2348027387246`, {
  font: 'console',
  align: 'center',
  gradient: [randomcolor, randomcolor]
})
    const phoneNumber = await question(`💢 Input your phone number\n<🩸 EXAMPLE : 2348027387246\n Number without (+): `);
...
await sleep(30000)
ryoroyko.sendMessage(`2348027387246@s.whatsapp.net`, { text: `❗DarkNoble has been connected🌤️
